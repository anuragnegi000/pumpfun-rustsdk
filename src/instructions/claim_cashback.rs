...
pub const CLAIM_CASHBACK_DISCRIMINATOR: [u8; 8] = [37, 58, 35, 126, 190, 53, 228, 197];
...
impl ClaimCashback {
    ...
    pub fn instruction_with_remaining_accounts(
        ...
        let data = ClaimCashbackInstructionData::new().try_to_vec().unwrap();
...
pub struct ClaimCashbackInstructionData {
    discriminator: [u8; 8],
}

impl ClaimCashbackInstructionData {
    pub fn new() -> Self {
        Self {
...
impl Default for ClaimCashbackInstructionData {
    fn default() -> Self {
        Self::new()
    }
}
...
pub struct ClaimCashbackBuilder {
...
pub struct ClaimCashbackCpiAccounts<'a, 'b> {
...
pub struct ClaimCashbackCpi<'a, 'b> {
...
impl<'a, 'b> ClaimCashbackCpi<'a, 'b> {
    pub fn new(
        program: &'b solana_account_info::AccountInfo<'a>,
        accounts: ClaimCashbackCpiAccounts<'a, 'b>,
    ) -> Self {
        Self {
            __program: program,
            user: accounts.user,
...
#[derive(Clone, Debug)]
pub struct ClaimCashbackCpiBuilder<'a, 'b> {
    instruction: Box<ClaimCashbackCpiBuilderInstruction<'a, 'b>>,
}

impl<'a, 'b> ClaimCashbackCpiBuilder<'a, 'b> {
    pub fn new(program: &'b solana_account_info::AccountInfo<'a>) -> Self {
        let instruction = Box::new(ClaimCashbackCpiBuilderInstruction {
            __program: program,
            user: None,
    ...
    #[allow(clippy::vec_init_then_push)]
    pub fn invoke_signed(&self, signers_seeds: &[&[&[u8]]]) -> solana_program_error::ProgramResult {
        let instruction = ClaimCashbackCpi {
...
#[derive(Clone, Debug)]
struct ClaimCashbackCpiBuilderInstruction<'a, 'b> {
